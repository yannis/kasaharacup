...
RSpec.describe KenshisController, type: :controller do
  ...
  describe "with 3 kenshis in the database," do
    ...
    KENSHI_CONT_METHODS = ["get :new, locale: I18n.locale, cup_id: cup.to_param",
      "post :create, cup_id: cup.to_param, kenshi: {last_name: 'just created kenshi'}, locale: I18n.locale", "put :update, cup_id: cup.to_param, id: kenshi1.to_param, kenshi: {last_name: 'just updated kenshi'}, locale: I18n.locale", "delete :destroy, cup_id: cup.to_param, id: kenshi1.to_param, locale: I18n.locale"]
    ...
    context "when not logged in," do
      ...
      describe "on GET to :index with param :user_id" do
        before { get :index, params: {cup_id: cup.to_param, user_id: user.to_param, locale: I18n.locale} }
      ...
      describe "when GET to :show for kenshi1.id," do
        before { get :show, params: {cup_id: cup.to_param, id: kenshi1.to_param, locale: I18n.locale} }
      ...
      describe "when GET to :show for kenshi1.id with param :user_id" do
        before {
          get :show, params: {cup_id: cup.to_param, user_id: user.to_param, id: kenshi1.to_param, locale: I18n.locale}
        }
    ...
    describe "when logged in" do
      ...
      describe "when GET to :new with user_id: basic_user.to_param," do
        before { get :new, params: {cup_id: cup.to_param, user_id: basic_user.to_param, locale: I18n.locale} }

        it {
          expect(assigns(:current_user)).to eql basic_user
        }
      ...
      describe "when GET to :new without user_id param," do
        before { get :new, params: {cup_id: cup.to_param, locale: I18n.locale} }
      ...
      describe "when POST to :create with valid data," do
        before {
          post :create,
            params: {kenshi: valid_params, cup_id: cup.to_param, user_id: basic_user.to_param, locale: I18n.locale}
        }
      ...
      describe "when POST to :create with invalid data," do
        before {
          post :create,
            params: {kenshi: {last_name: ""}, cup_id: cup.to_param, user_id: basic_user.to_param, locale: I18n.locale}
        }
      ...
      describe "on GET to :edit with :id = basic_user_kenshi.to_param," do
        before { get :edit, params: {cup_id: cup.to_param, id: basic_user_kenshi.to_param, locale: I18n.locale} }
      ...
      describe "on PUT to :update with :id = basic_user_kenshi.to_param and valid data" do
        before {
          put :update,
            params: {cup_id: cup.to_param, id: basic_user_kenshi.to_param, kenshi: {last_name: "alaNma2"},
                     locale: I18n.locale}
        }
      ...
      describe "on PUT to :update with :id = basic_user_kenshi.to_param and invalid data," do
        before {
          put :update,
            params: {id: basic_user_kenshi.to_param, cup_id: cup.to_param, kenshi: {last_name: ""}, locale: I18n.locale}
        }
      ...
      describe "on DELETE to :destroy with :id = basic_user_kenshi.to_param," do
        before {
          ...
          delete :destroy, params: {cup_id: cup.to_param, id: basic_user_kenshi.to_param, locale: I18n.locale}
        }
      ...
      context "when deadline is passed" do
        ...
        describe "when POST to :create with valid data," do
          before { post :create, params: {cup_id: cup.to_param, kenshi: valid_params, locale: I18n.locale} }
