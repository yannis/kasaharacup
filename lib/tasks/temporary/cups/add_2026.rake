    ...
    task add_2026: :environment do
      ...
      individual_categories_data = [
        ...
        },
        {
          ...
          Les participants nés en #{2026 - 16}
          et #{2026 - 17} devront présenter une décharge signée par un représentant légal".squish
        },
        {
          name: "Ladies",
          pool_size: 3,
      ...
      ActiveRecord::Base.transaction do
        cup = Cup.find_or_create_by(start_on: "2026-09-26", end_on: "2026-09-27", year: 2026)
        unless cup.header_image.attached?
          create_header_image(cup: cup, image: "hero-2026.jpg")
        end
        ...
        cup.update!(
          ...
          deadline: "2026-09-15",
          registerable_at: "2026-05-01 00:00:00",
          description_en: nil,
          description_fr: nil
        )
      end
