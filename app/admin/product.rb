...
ActiveAdmin.register Product, as: "Product" do
  permit_params :name_en, :name_fr, :description_en, :description_fr, :cup_id, :event_id,
    :fee_chf, :fee_eu, :quota, :position, :display, :require_personal_infos
  ...
  form do |f|
    f.inputs "Details" do
      ...
      f.input :require_personal_infos, as: :boolean
