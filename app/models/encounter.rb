...
class Encounter < ApplicationRecord
  ...
  # No RESULT recorded: no winner and no scored bout. The bar a draw-correction
  # swap has to clear.
  #
  ...
  # seeded lineup is not work worth protecting: #assign_team_to_slot ->
  # #invalidate_slot clears the outgoing side's fighters, its points and its
  # flag on every swap.
  def unscored?
    winner_id.nil? &&
