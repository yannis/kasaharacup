...
module HasLocale
  ...
  private def set_locale
    ...
    request_locale = AcceptLanguage.best_locale(request.env["HTTP_ACCEPT_LANGUAGE"])

    @locale = params_locale.presence || session_locale.presence || request_locale || I18n.default_locale
